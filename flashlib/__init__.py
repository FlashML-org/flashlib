...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    "flash_kmeans_nki":          ("flashlib.primitives.kmeans", "flash_kmeans_nki"),
    # knn -- single fused entry point (Triton/CuteDSL/NKI).
    ...
    "flash_knn_nki":             ("flashlib.primitives.knn", "flash_knn_nki"),
