...
def _compiled_partial_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0325"}, "kernel_flash_kmeans_assign_highd_splitk_partial_8de8_v1", 51200, 192]}'))

def _compiled_reduce_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0326"}, "kernel_flash_kmeans_assign_highd_splitk_reduce_8de8_v1", 0, 128]}'))
