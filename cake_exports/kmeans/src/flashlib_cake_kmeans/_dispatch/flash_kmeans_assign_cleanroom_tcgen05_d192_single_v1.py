...
def _compiled_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0344"}, "kernel_flash_kmeans_assign_cleanroom_tcgen05_d192_single_v1", 149504, 192]}'))
