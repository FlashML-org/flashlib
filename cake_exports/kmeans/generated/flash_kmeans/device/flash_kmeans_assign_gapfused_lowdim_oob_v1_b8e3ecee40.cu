...
// Provenance: loom @ 9dd3df73eea8632ec145151e6ae5c5a88dd59969. schedule symbol 'flash_kmeans_assign_gapfused_lowdim_oob_v1'; embedded in the host TU as flash_kmeans_assign_gapfused_lowdim_oob_v1_b8e3ecee40.
...
kernel_flash_kmeans_assign_gapfused_lowdim_oob_v1(const void* __restrict__ x_tmap, const void* __restrict__ c_tmap, float* __restrict__ x_sq, float* __restrict__ c_sq, int* __restrict__ out, int B, int N, int D, int K, int num_n_tiles, int K_tiles)
{
