...
// Provenance: loom @ ff502f39df09ffdb317efc57ebdac3a668bb3aa4. schedule symbol 'flash_kmeans_assign_gapfused_highd_splitd_oob_v1'; embedded in the host TU as flash_kmeans_assign_gapfused_highd_splitd_oob_v1_b8e3ecee40.
...
kernel_flash_kmeans_assign_gapfused_highd_splitd_oob_v1(const void* __restrict__ x_tmap, const void* __restrict__ c_tmap, float* __restrict__ x_sq, float* __restrict__ c_sq, int* __restrict__ out, int B, int N, int D, int K, int num_n_tiles, int K_tiles)
{
