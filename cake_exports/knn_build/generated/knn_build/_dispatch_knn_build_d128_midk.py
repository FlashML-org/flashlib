"""Runtime-free tvm-ffi loader for the knn_build_d128_midk dispatch-family .so.
...
from . import _dispatch_ws_knn_build_d128_midk as _ws
...
def _load(arch: str) -> Any:
    ...
    binary = _res.files('knn_build').joinpath(f"_dispatch_so/knn_build_d128_midk/{arch}/{FAMILY_SO}")
