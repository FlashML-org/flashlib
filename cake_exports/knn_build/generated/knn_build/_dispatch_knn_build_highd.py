"""Runtime-free tvm-ffi loader for the knn_build_highd dispatch-family .so.
...
from . import _dispatch_ws_knn_build_highd as _ws
...
def _load(arch: str) -> Any:
    ...
    binary = _res.files('knn_build').joinpath(f"_dispatch_so/knn_build_highd/{arch}/{FAMILY_SO}")
