...
// Provenance: loom @ ff502f39df09ffdb317efc57ebdac3a668bb3aa4. schedule symbol 'knn_build_evolve_7bfc_split_cg2_u2_stage1_k32split'; embedded in the host TU as knn_build_evolve_7bfc_split_cg2_u2_stage1_k32split_260825eb93.
...
kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_k32split(const void* __restrict__ tmap_query, const void* __restrict__ tmap_database, float* __restrict__ query_sq, float* __restrict__ database_sq, float* __restrict__ partial_dists, int* __restrict__ partial_indices, int B, int Q, int M, int K, int num_q_tile_pairs, int db_tiles_per_split, int split_count, int total_work)
{
