...
// Provenance: loom @ ff502f39df09ffdb317efc57ebdac3a668bb3aa4. schedule symbol 'knn_build_evolve_7bfc_v1_k32_fallback'; embedded in the host TU as knn_build_evolve_7bfc_v1_k32_fallback_260825eb93.
...
kernel_knn_build_evolve_7bfc_v1_k32_fallback(const void* __restrict__ tmap_query, const void* __restrict__ tmap_database, float* __restrict__ query_sq, float* __restrict__ database_sq, float* __restrict__ out_dists, int* __restrict__ out_indices, int B, int Q, int M, int K, int num_q_tiles, int num_db_tiles, int total_tiles)
{
