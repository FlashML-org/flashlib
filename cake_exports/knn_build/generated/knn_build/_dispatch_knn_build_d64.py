"""Runtime-free tvm-ffi loader for the knn_build_d64 dispatch-family .so.
...
from . import _dispatch_ws_knn_build_d64 as _ws
...
def _load(arch: str) -> Any:
    ...
    binary = _res.files('knn_build').joinpath(f"_dispatch_so/knn_build_d64/{arch}/{FAMILY_SO}")
