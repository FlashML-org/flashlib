...
#undef LOOM_INF
#undef NUM_MAIN_STAGES
#undef SMEM_SMEM_DATABASE_LO_OFF
#undef SMEM_SMEM_DATABASE_LO_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_LO_STRIDE
#undef SMEM_SMEM_DATABASE_MID_OFF
#undef SMEM_SMEM_DATABASE_MID_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_MID_STRIDE
#undef SMEM_SMEM_DATABASE_OFF
#undef SMEM_SMEM_DATABASE_SQ_OFF
#undef SMEM_SMEM_DATABASE_SQ_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_SQ_STRIDE
#undef SMEM_SMEM_DATABASE_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_STRIDE
#undef SMEM_SMEM_DATABASE_TAIL_OFF
#undef SMEM_SMEM_DATABASE_TAIL_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_TAIL_STRIDE
#undef SMEM_SMEM_QUERY_LO_OFF
#undef SMEM_SMEM_QUERY_LO_STAGE_BYTES
#undef SMEM_SMEM_QUERY_LO_STRIDE
#undef SMEM_SMEM_QUERY_MID_OFF
#undef SMEM_SMEM_QUERY_MID_STAGE_BYTES
#undef SMEM_SMEM_QUERY_MID_STRIDE
#undef SMEM_SMEM_QUERY_OFF
#undef SMEM_SMEM_QUERY_STAGE_BYTES
#undef SMEM_SMEM_QUERY_STRIDE
#undef SMEM_SMEM_QUERY_TAIL_OFF
#undef SMEM_SMEM_QUERY_TAIL_STAGE_BYTES
#undef SMEM_SMEM_QUERY_TAIL_STRIDE
#undef SMEM_TOTAL
#undef THREADS
#undef TMEM_CROSS_OFFSET
#undef TMEM_NCOLS
...
#undef score_full_addr
#undef smem_database_addr
#undef smem_database_lo_addr
#undef smem_database_mid_addr
#undef smem_database_sq_addr
#undef smem_database_tail_addr
#undef smem_query_addr
#undef smem_query_lo_addr
#undef smem_query_mid_addr
#undef smem_query_tail_addr
