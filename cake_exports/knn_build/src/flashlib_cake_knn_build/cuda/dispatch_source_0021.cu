...
#undef LOOM_INF
#undef NUM_MAIN_STAGES
#undef SMEM_SMEM_DATABASE_HI_OFF
#undef SMEM_SMEM_DATABASE_HI_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_HI_STRIDE
...
#undef SMEM_SMEM_DATABASE_STAGE_BYTES
#undef SMEM_SMEM_DATABASE_STRIDE
#undef SMEM_SMEM_QUERY_HI_OFF
#undef SMEM_SMEM_QUERY_HI_STAGE_BYTES
#undef SMEM_SMEM_QUERY_HI_STRIDE
