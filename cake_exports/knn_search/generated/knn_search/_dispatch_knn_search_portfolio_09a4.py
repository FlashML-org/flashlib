"""Runtime-free tvm-ffi loader for the knn_search_portfolio_09a4 dispatch-family .so.
...
from . import _dispatch_ws_knn_search_portfolio_09a4 as _ws
...
def _load(arch: str) -> Any:
    ...
    binary = _res.files('knn_search').joinpath(f"_dispatch_so/knn_search_portfolio_09a4/{arch}/{FAMILY_SO}")
