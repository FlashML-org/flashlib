"""Runtime-free tvm-ffi loader for the knn_search_registered_b653 dispatch-family .so.
...
from . import _dispatch_ws_knn_search_registered_b653 as _ws
...
def _load(arch: str) -> Any:
    ...
    binary = _res.files('knn_search').joinpath(f"_dispatch_so/knn_search_registered_b653/{arch}/{FAMILY_SO}")
