...
// Provenance: loom @ ff502f39df09ffdb317efc57ebdac3a668bb3aa4. schedule symbol 'knn_search_mma_split_partial_v1_fullm'; embedded in the host TU as knn_search_mma_split_partial_v1_fullm_47f53bdb8c.
...
kernel_knn_search_mma_split_partial_v1_fullm(__nv_bfloat16* __restrict__ queries, __nv_bfloat16* __restrict__ database, float* __restrict__ partial_distances, int* __restrict__ partial_indices, int B, int Q, int M, int split_m, int num_q_tiles, int total_m_tiles, int tiles_per_split)
{
