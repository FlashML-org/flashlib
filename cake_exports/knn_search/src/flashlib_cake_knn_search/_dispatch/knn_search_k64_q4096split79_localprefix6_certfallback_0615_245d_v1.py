...
def _compile_k64_q4096_prefix6cert_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"cert": {"__kernel__": "dispatch_kernel_0368"}, "certflag_init": {"__kernel__": "dispatch_kernel_0367"}, "merge": {"__kernel__": "dispatch_kernel_0366"}, "partial": {"__kernel__": "dispatch_kernel_0365"}}'))
