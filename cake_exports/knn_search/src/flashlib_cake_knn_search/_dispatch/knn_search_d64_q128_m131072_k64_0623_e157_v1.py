...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0476"}, "group_merge": {"__kernel__": "dispatch_kernel_0475"}, "partial": {"__kernel__": "dispatch_kernel_0474"}}'))
