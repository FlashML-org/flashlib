...
def _compile_b2_q128_m65536_k64_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0413"}, "group_merge": {"__kernel__": "dispatch_kernel_0412"}, "partial": {"__kernel__": "dispatch_kernel_0411"}}'))
