...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final": {"__kernel__": "dispatch_kernel_0582"}, "group": {"__kernel__": "dispatch_kernel_0581"}, "partial": {"__kernel__": "dispatch_kernel_0580"}, "tail_final": {"__kernel__": "dispatch_kernel_0584"}, "tail_group": {"__kernel__": "dispatch_kernel_0583"}}'))
