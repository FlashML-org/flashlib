...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"direct": {"__kernel__": "dispatch_kernel_0233"}, "merge": {"__kernel__": "dispatch_kernel_0232"}, "partial": {"__kernel__": "dispatch_kernel_0231"}}'))
