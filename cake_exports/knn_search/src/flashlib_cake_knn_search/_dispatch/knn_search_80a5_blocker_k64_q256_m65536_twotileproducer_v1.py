...
def _compile_q256_m65536_twotile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0418"}, "group_merge": {"__kernel__": "dispatch_kernel_0417"}, "partial": {"__kernel__": "dispatch_kernel_0416"}}'))
