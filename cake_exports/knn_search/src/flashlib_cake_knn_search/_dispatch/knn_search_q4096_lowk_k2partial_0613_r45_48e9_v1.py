...
def _compile_lowk_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_lowk1": {"__kernel__": "dispatch_kernel_0334"}, "merge_lowk2": {"__kernel__": "dispatch_kernel_0335"}, "partial_lowk": {"__kernel__": "dispatch_kernel_0333"}}'))
