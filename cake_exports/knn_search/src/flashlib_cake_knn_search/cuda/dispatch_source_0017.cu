...
#undef mma_done2_addr
#undef mma_done3_addr
#undef mma_done4_addr
#undef mma_done5_addr
#undef mma_done6_addr
#undef mma_done7_addr
#undef smem_a_addr
#undef smem_b_addr
#undef smem_cohort_topk_d_addr
#undef smem_cohort_topk_i_addr
...
#undef SMEM_SMEM_Q_CACHE_OFF
#undef SMEM_SMEM_Q_CACHE_STAGE_BYTES
#undef SMEM_SMEM_Q_CACHE_STRIDE
#undef SMEM_SMEM_Q_NORM_PART_OFF
#undef SMEM_SMEM_Q_NORM_PART_STAGE_BYTES
#undef SMEM_SMEM_Q_NORM_PART_STRIDE
#undef SMEM_TOTAL
...
#undef SMEM_SMEM_A_STAGE_BYTES
#undef SMEM_SMEM_A_STRIDE
#undef SMEM_SMEM_B0_OFF
#undef SMEM_SMEM_B0_STAGE_BYTES
#undef SMEM_SMEM_B0_STRIDE
#undef SMEM_SMEM_B1_OFF
#undef SMEM_SMEM_B1_STAGE_BYTES
#undef SMEM_SMEM_B1_STRIDE
#undef SMEM_SMEM_DB_NORM0_OFF
#undef SMEM_SMEM_DB_NORM0_STAGE_BYTES
#undef SMEM_SMEM_DB_NORM0_STRIDE
#undef SMEM_SMEM_DB_NORM1_OFF
#undef SMEM_SMEM_DB_NORM1_STAGE_BYTES
#undef SMEM_SMEM_DB_NORM1_STRIDE
#undef SMEM_SMEM_DB_NORM_PART_OFF
#undef SMEM_SMEM_DB_NORM_PART_STAGE_BYTES
#undef SMEM_SMEM_DB_NORM_PART_STRIDE
#undef SMEM_SMEM_LOCAL_D_OFF
...
#undef SMEM_TOTAL
#undef THREADS
#undef TMEM_ACC0_OFFSET
#undef TMEM_ACC1_OFFSET
#undef TMEM_NCOLS
#undef mma_done0_addr
#undef mma_done1_addr
#undef smem_a_addr
#undef smem_b0_addr
#undef smem_b1_addr
#undef smem_db_norm0_addr
#undef smem_db_norm1_addr
#undef smem_db_norm_part_addr
#undef smem_local_d_addr
#undef smem_local_i_addr
#undef smem_q_norm_part_addr
