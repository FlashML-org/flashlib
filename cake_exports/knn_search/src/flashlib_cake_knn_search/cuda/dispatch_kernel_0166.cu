            ...
            for (int e_vec_1 = tid; e_vec_1 < 512; e_vec_1 += 640) {
                ...
                unsigned int q_pack_1[8];
                {
                    ...
                    for (int _blk = 0; _blk < 2; _blk++) {
                        ...
                        #pragma unroll
                        for (int _j = 0; _j < 8; _j++)
                            q_vals_1[0 + _blk * 8 + _j] = __bfloat162float(_velems_2[_j]);
                    }
                }
                #pragma unroll
                for (int _lp = 0; _lp < 8; _lp++) {
            ...
            for (int e_vec_3 = tid; e_vec_3 < 512; e_vec_3 += 640) {
                ...
                unsigned int q_pack_3[8];
                {
                    ...
                    for (int _blk = 0; _blk < 2; _blk++) {
                        ...
                        #pragma unroll
                        for (int _j = 0; _j < 8; _j++)
                            q_vals_3[0 + _blk * 8 + _j] = __bfloat162float(_velems_6[_j]);
                    }
                }
                #pragma unroll
                for (int _lp = 0; _lp < 8; _lp++) {
                            ...
                            if (global_d_7 < D_ORIG_) {
                                {
                                    ...
                                    for (int _blk = 0; _blk < 2; _blk++) {
                                        ...
                                        #pragma unroll
                                        for (int _j = 0; _j < 8; _j++)
                                            db_vals_3[0 + _blk * 8 + _j] = __bfloat162float(_velems_7[_j]);
                                    }
                                }
                            }
                        }
            ...
            for (int e_vec_4 = tid; e_vec_4 < 512; e_vec_4 += 640) {
                ...
                unsigned int q_pack_4[8];
                {
                    ...
                    for (int _blk = 0; _blk < 2; _blk++) {
                        ...
                        #pragma unroll
                        for (int _j = 0; _j < 8; _j++)
                            q_vals_4[0 + _blk * 8 + _j] = __bfloat162float(_velems_8[_j]);
                    }
                }
                #pragma unroll
                for (int _lp = 0; _lp < 8; _lp++) {
                            ...
                            if (global_d_9 < D_ORIG_) {
                                {
                                    ...
                                    for (int _blk = 0; _blk < 2; _blk++) {
                                        ...
                                        #pragma unroll
                                        for (int _j = 0; _j < 8; _j++)
                                            db_vals_4[0 + _blk * 8 + _j] = __bfloat162float(_velems_9[_j]);
                                    }
                                }
                            }
                        }
            ...
            for (int e_vec_5 = tid; e_vec_5 < 512; e_vec_5 += 640) {
                ...
                unsigned int q_pack_5[8];
                {
                    ...
                    for (int _blk = 0; _blk < 2; _blk++) {
                        ...
                        #pragma unroll
                        for (int _j = 0; _j < 8; _j++)
                            q_vals_5[0 + _blk * 8 + _j] = __bfloat162float(_velems_10[_j]);
                    }
                }
                #pragma unroll
                for (int _lp = 0; _lp < 8; _lp++) {
                            ...
                            if (global_d_11 < D_ORIG_) {
                                {
                                    ...
                                    for (int _blk = 0; _blk < 2; _blk++) {
                                        ...
                                        #pragma unroll
                                        for (int _j = 0; _j < 8; _j++)
                                            db_vals_5[0 + _blk * 8 + _j] = __bfloat162float(_velems_11[_j]);
                                    }
                                }
                            }
                        }
